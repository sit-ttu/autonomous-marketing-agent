  ...
  return html`
    <section class="card">
      ...
      >
        <a
          class="btn btn--sm"
          href="https://docs.foxfang.ai/tools/skills"
          target="_blank"
          rel="noreferrer"
          title="Browse skills documentation"
          >Browse Skills Docs</a
        >
...
function renderSkillDetail(skill: SkillStatusEntry, props: SkillsProps) {
  ...
  const showBundledBadge = Boolean(skill.bundled && skill.source !== "foxfang-bundled");
