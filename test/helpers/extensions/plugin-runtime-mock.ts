import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "foxfang/plugin-sdk/agent-runtime";
import type { PluginRuntime } from "foxfang/plugin-sdk/testing";
import { removeAckReactionAfterReply, shouldAckReaction } from "foxfang/plugin-sdk/testing";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/foxfang"),
    },
    modelAuth: {
