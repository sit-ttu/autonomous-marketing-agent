...
vi.mock("foxfang/plugin-sdk/web-media", async () => {
...
let loadWebMedia: typeof import("foxfang/plugin-sdk/web-media").loadWebMedia;
...
beforeAll(async () => {
  ...
  ({ loadWebMedia } = await import("foxfang/plugin-sdk/web-media"));
