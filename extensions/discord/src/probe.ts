import type { BaseProbeResult } from "foxfang/plugin-sdk/channel-contract";
import { resolveFetch } from "foxfang/plugin-sdk/fetch-runtime";
import { fetchWithTimeout } from "foxfang/plugin-sdk/text-runtime";
