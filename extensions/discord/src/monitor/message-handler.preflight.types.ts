...
import type { resolveAgentRoute } from "foxfang/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("foxfang/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("foxfang/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("foxfang/plugin-sdk/config-runtime").FoxFangConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
