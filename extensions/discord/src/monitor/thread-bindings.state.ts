...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "foxfang/plugin-sdk/routing";
...
const THREAD_BINDINGS_STATE_KEY = Symbol.for("foxfang.discordThreadBindingsState");
