...
export type DiscordConfig = NonNullable<FoxFangConfig["channels"]>["discord"];
...
export function createDiscordPreflightArgs(params: {
  ...
  return {
    ...
    accountId: "default",
    token: "token",
    runtime: {} as import("foxfang/plugin-sdk/runtime-env").RuntimeEnv,
    botUserId: params.botUserId ?? "foxfang-bot",
