...
export async function resolveTlonSetupConfigured(cfg: FoxFangConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: FoxFangConfig): Promise<string[]> {
