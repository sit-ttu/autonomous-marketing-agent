...
import { createTopLevelChannelConfigAdapter } from "foxfang/plugin-sdk/channel-config-helpers";
import type {
...
import type { ChannelMessageActionName, ChannelPlugin, FoxFangConfig } from "../runtime-api.js";
import {
...
const resolveMSTeamsChannelConfig = (cfg: FoxFangConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: FoxFangConfig }>(
