...
function mergeZaloAccountConfig(cfg: FoxFangConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: FoxFangConfig): ResolvedZaloAccount[] {
