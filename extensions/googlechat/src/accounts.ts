...
import { isSecretRef, type FoxFangConfig } from "foxfang/plugin-sdk/core";
...
export function listEnabledGoogleChatAccounts(cfg: FoxFangConfig): ResolvedGoogleChatAccount[] {
