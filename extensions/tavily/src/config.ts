...
export function resolveTavilySearchConfig(cfg?: FoxFangConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: FoxFangConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: FoxFangConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
