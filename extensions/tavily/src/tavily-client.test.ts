...
vi.mock("foxfang/plugin-sdk/provider-web-search", () => ({
...
vi.mock("foxfang/plugin-sdk/security-runtime", () => ({
...
describe("tavily client X-Client-Source header", () => {
  ...
  it("runTavilySearch sends X-Client-Source: foxfang", async () => {
    ...
    expect(params.extraHeaders).toEqual({ "X-Client-Source": "foxfang" });
  });

  it("runTavilyExtract sends X-Client-Source: foxfang", async () => {
