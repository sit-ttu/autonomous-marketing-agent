import type { BrowserConfig, BrowserProfileConfig, FoxFangConfig } from "../config/config.js";
...
import {
  ...
  DEFAULT_FOXFANG_BROWSER_ENABLED,
...
function normalizeHexColor(raw: string | undefined) {
  ...
  if (!value) {
    return DEFAULT_FOXFANG_BROWSER_COLOR;
  }
...
/**
 * Ensure the default "foxfang" profile exists in the profiles map.
...
function ensureDefaultProfile(
  ...
  if (!result[DEFAULT_FOXFANG_BROWSER_PROFILE_NAME]) {
    result[DEFAULT_FOXFANG_BROWSER_PROFILE_NAME] = {
...
export function resolveBrowserConfig(
  ...
  const enabled = cfg?.enabled ?? DEFAULT_FOXFANG_BROWSER_ENABLED;
  ...
  const defaultProfile =
    ...
    (profiles[DEFAULT_BROWSER_DEFAULT_PROFILE_NAME]
      ? DEFAULT_BROWSER_DEFAULT_PROFILE_NAME
      : profiles[DEFAULT_FOXFANG_BROWSER_PROFILE_NAME]
        ? DEFAULT_FOXFANG_BROWSER_PROFILE_NAME
        : "user");
...
export function resolveProfile(
  ...
  let cdpUrl = "";
  const driver = profile.driver === "existing-session" ? "existing-session" : "foxfang";
