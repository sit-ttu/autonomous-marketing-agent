import type { ProviderNormalizeResolvedModelContext } from "foxfang/plugin-sdk/core";
import type { ModelProviderConfig, ProviderPlugin } from "foxfang/plugin-sdk/provider-model-shared";
