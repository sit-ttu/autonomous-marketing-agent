...
type WebSearchConfig = NonNullable<FoxFangConfig["tools"]>["web"] extends infer Web
  ? Web extends { search?: infer Search }
    ? Search
    : undefined
  : undefined;

type WebFetchConfig = NonNullable<FoxFangConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: FoxFangConfig): WebSearchConfig {
...
function resolveFetchConfig(cfg?: FoxFangConfig): WebFetchConfig {
...
export function resolveFirecrawlSearchConfig(cfg?: FoxFangConfig): FirecrawlSearchConfig {
...
export function resolveFirecrawlFetchConfig(cfg?: FoxFangConfig): FirecrawlFetchConfig {
...
export function resolveFirecrawlApiKey(cfg?: FoxFangConfig): string | undefined {
...
export function resolveFirecrawlBaseUrl(cfg?: FoxFangConfig): string {
  const search = resolveFirecrawlSearchConfig(cfg);
  const fetch = resolveFirecrawlFetchConfig(cfg);
  const configured =
...
export function resolveFirecrawlOnlyMainContent(cfg?: FoxFangConfig, override?: boolean): boolean {
...
export function resolveFirecrawlMaxAgeMs(cfg?: FoxFangConfig, override?: number): number {
