...
function enableSlackAccount(cfg: FoxFangConfig, accountId: string): FoxFangConfig {
...
function hasSlackInteractiveRepliesConfig(cfg: FoxFangConfig, accountId: string): boolean {
...
function createSlackTokenCredential(params: {
  ...
  return {
    ...
    applyUseEnv: ({ cfg, accountId }: { cfg: FoxFangConfig; accountId: string }) =>
