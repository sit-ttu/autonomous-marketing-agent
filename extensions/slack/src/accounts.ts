...
export function mergeSlackAccountConfig(cfg: FoxFangConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: FoxFangConfig): ResolvedSlackAccount[] {
