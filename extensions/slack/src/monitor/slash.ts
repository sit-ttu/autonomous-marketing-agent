...
import { type ChatCommandDefinition, type CommandArgs } from "foxfang/plugin-sdk/command-auth";
import {
...
import { chunkItems } from "foxfang/plugin-sdk/text-runtime";
...
const SLACK_COMMAND_ARG_ACTION_ID = "foxfang_cmdarg";
