import { resolveMarkdownTableMode as resolveMarkdownTableModeImpl } from "foxfang/plugin-sdk/config-runtime";
import {
...
} from "foxfang/plugin-sdk/reply-runtime";
import { resolveAgentRoute as resolveAgentRouteImpl } from "foxfang/plugin-sdk/routing";
import { deliverSlackSlashReplies as deliverSlackSlashRepliesImpl } from "./replies.js";

type ResolveChunkMode = typeof import("foxfang/plugin-sdk/reply-runtime").resolveChunkMode;
type FinalizeInboundContext =
  typeof import("foxfang/plugin-sdk/reply-runtime").finalizeInboundContext;
type DispatchReplyWithDispatcher =
  typeof import("foxfang/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher;
type ResolveConversationLabel =
  typeof import("foxfang/plugin-sdk/conversation-runtime").resolveConversationLabel;
type RecordInboundSessionMetaSafe =
  typeof import("foxfang/plugin-sdk/conversation-runtime").recordInboundSessionMetaSafe;
type ResolveMarkdownTableMode =
  typeof import("foxfang/plugin-sdk/config-runtime").resolveMarkdownTableMode;
type ResolveAgentRoute = typeof import("foxfang/plugin-sdk/routing").resolveAgentRoute;
