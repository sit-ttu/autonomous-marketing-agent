...
// Prefix for FoxFang-generated action IDs to scope our handler
const FOXFANG_ACTION_PREFIX = "foxfang:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${FOXFANG_ACTION_PREFIX}`);

  // Handle FoxFang modal submissions with callback_ids scoped by our prefix.
  registerModalLifecycleHandler({
