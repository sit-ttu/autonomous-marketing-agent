...
import {
  ...
  resolveUserPath,
  type FoxFangConfig,
} from "foxfang/plugin-sdk/account-core";
...
export function listWhatsAppAuthDirs(cfg: FoxFangConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: FoxFangConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: FoxFangConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: FoxFangConfig): ResolvedWhatsAppAccount[] {
