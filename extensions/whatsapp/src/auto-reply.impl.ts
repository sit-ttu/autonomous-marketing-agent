export { HEARTBEAT_PROMPT, stripHeartbeatToken } from "foxfang/plugin-sdk/reply-runtime";
export { HEARTBEAT_TOKEN, SILENT_REPLY_TOKEN } from "foxfang/plugin-sdk/reply-runtime";
