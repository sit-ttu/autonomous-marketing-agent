...
vi.mock("foxfang/plugin-sdk/memory-core-host-engine-foundation", async () => {
  const actual = await vi.importActual<
    typeof import("foxfang/plugin-sdk/memory-core-host-engine-foundation")
  >("foxfang/plugin-sdk/memory-core-host-engine-foundation");
  return {
    ...actual,
...
import type { FoxFangConfig } from "foxfang/plugin-sdk/memory-core-host-engine-foundation";
import {
  requireNodeSqlite,
...
describe("QmdMemoryManager", () => {
  ...
  async function createManager(params?: { mode?: "full" | "status"; cfg?: FoxFangConfig }) {
