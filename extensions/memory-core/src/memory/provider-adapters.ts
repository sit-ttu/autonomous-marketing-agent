...
import { resolveUserPath } from "foxfang/plugin-sdk/memory-core-host-engine-foundation";
import { getProviderEnvVars } from "foxfang/plugin-sdk/provider-env-vars";
...
function formatLocalSetupError(err: unknown): string {
  ...
  return [
    ...
    missing
      ? "2) Reinstall FoxFang (this should install node-llama-cpp): npm i -g foxfang@latest"
      : null,
