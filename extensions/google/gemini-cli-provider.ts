...
import { buildOauthProviderAuthResult } from "foxfang/plugin-sdk/provider-auth-result";
import { fetchGeminiUsage } from "foxfang/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: FoxFangPluginApi) {
