import { DEFAULT_ACCOUNT_ID, type FoxFangConfig } from "foxfang/plugin-sdk/account-resolution";
import { waitUntilAbort } from "foxfang/plugin-sdk/channel-lifecycle";
import { registerPluginHttpRoute } from "foxfang/plugin-sdk/webhook-ingress";
