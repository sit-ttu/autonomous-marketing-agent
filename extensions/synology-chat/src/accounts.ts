...
import { resolveDangerousNameMatchingEnabled } from "foxfang/plugin-sdk/config-runtime";
import type {
...
/** Extract the channel config from the full FoxFang config object. */
function getChannelConfig(cfg: FoxFangConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: FoxFangConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.FOXFANG_BOT_NAME ?? "FoxFang";
