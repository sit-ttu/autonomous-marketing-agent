...
vi.mock("foxfang/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("foxfang/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("foxfang/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("foxfang/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("foxfang/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("foxfang/plugin-sdk/webhook-ingress");
  return {
    ...actual,
