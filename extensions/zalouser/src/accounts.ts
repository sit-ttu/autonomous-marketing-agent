...
function mergeZalouserAccountConfig(cfg: FoxFangConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: FoxFangConfig; accountId?: string | null }) {
