...
This directory contains the **BlueBubbles external channel plugin** for FoxFang.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `foxfang/plugin-sdk` helpers.
