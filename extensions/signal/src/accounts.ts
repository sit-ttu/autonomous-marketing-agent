...
function mergeSignalAccountConfig(cfg: FoxFangConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: FoxFangConfig): ResolvedSignalAccount[] {
