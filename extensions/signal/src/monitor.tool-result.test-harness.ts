...
vi.mock("foxfang/plugin-sdk/config-runtime", async () => {
  const actual = await vi.importActual<typeof import("foxfang/plugin-sdk/config-runtime")>(
    "foxfang/plugin-sdk/config-runtime",
  );
  return {
    ...actual,
    loadConfig: () => config,
    resolveStorePath: vi.fn(() => "/tmp/foxfang-sessions.json"),
...
vi.mock("foxfang/plugin-sdk/reply-runtime", async () => {
  const actual = await vi.importActual<typeof import("foxfang/plugin-sdk/reply-runtime")>(
    "foxfang/plugin-sdk/reply-runtime",
  );
  return {
    ...actual,
...
vi.mock("foxfang/plugin-sdk/conversation-runtime", async () => {
  const actual = await vi.importActual<typeof import("foxfang/plugin-sdk/conversation-runtime")>(
    "foxfang/plugin-sdk/conversation-runtime",
  );
  return {
    ...actual,
...
vi.mock("foxfang/plugin-sdk/security-runtime", async () => {
  const actual = await vi.importActual<typeof import("foxfang/plugin-sdk/security-runtime")>(
    "foxfang/plugin-sdk/security-runtime",
  );
  return {
    ...actual,
...
vi.mock("foxfang/plugin-sdk/channel-runtime", async () => {
  const actual = await vi.importActual<typeof import("foxfang/plugin-sdk/channel-runtime")>(
    "foxfang/plugin-sdk/channel-runtime",
  );
  return {
    ...actual,
...
export function installSignalToolResultTestHooks() {
  beforeEach(async () => {
    const [{ resetInboundDedupe }, { resetSystemEventsForTest }] = await Promise.all([
      import("foxfang/plugin-sdk/reply-runtime"),
      import("foxfang/plugin-sdk/channel-runtime"),
    ]);
    resetInboundDedupe();
    config = {
