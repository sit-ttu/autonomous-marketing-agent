import { definePluginEntry, type ProviderAuthContext } from "foxfang/plugin-sdk/plugin-entry";
import {
  coerceSecretRef,
  ensureAuthProfileStore,
  listProfilesForProvider,
} from "foxfang/plugin-sdk/provider-auth";
import { githubCopilotLoginCommand } from "foxfang/plugin-sdk/provider-auth-login";
