import { resolveDefaultAgentId } from "foxfang/plugin-sdk/agent-runtime";
import {
  isNativeCommandsExplicitlyDisabled,
  resolveNativeCommandsEnabled,
  resolveNativeSkillsEnabled,
} from "foxfang/plugin-sdk/config-runtime";
import type { FoxFangConfig, ReplyToMode } from "foxfang/plugin-sdk/config-runtime";
import {
...
import { DEFAULT_GROUP_HISTORY_LIMIT, type HistoryEntry } from "foxfang/plugin-sdk/reply-history";
