import type { createChannelPairingChallengeIssuer } from "foxfang/plugin-sdk/channel-pairing";
...
vi.mock("foxfang/plugin-sdk/channel-pairing", () => ({
...
vi.mock("foxfang/plugin-sdk/conversation-runtime", () => ({
