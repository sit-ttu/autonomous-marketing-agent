...
import { resolveApiKeyForProvider } from "foxfang/plugin-sdk/agent-runtime";
import type { ModelCatalogEntry } from "foxfang/plugin-sdk/agent-runtime";
import {
  findModelInCatalog,
  loadModelCatalog,
  modelSupportsVision,
} from "foxfang/plugin-sdk/agent-runtime";
...
import { loadJsonFile, saveJsonFile } from "foxfang/plugin-sdk/json-store";
import { AUTO_IMAGE_KEY_PROVIDERS, DEFAULT_IMAGE_MODELS } from "foxfang/plugin-sdk/media-runtime";
import { resolveAutoImageModel } from "foxfang/plugin-sdk/media-runtime";
import { describeImageFileWithModel } from "foxfang/plugin-sdk/media-understanding-runtime";
import { logVerbose } from "foxfang/plugin-sdk/runtime-env";
import { STATE_DIR } from "foxfang/plugin-sdk/state-paths";
