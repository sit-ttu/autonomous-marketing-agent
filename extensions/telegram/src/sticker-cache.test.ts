...
vi.mock("foxfang/plugin-sdk/media-runtime", () => ({
...
const TEST_CACHE_DIR = "/tmp/foxfang-test-sticker-cache/telegram";
...
describe("sticker-cache", () => {
  beforeEach(async () => {
    process.env.FOXFANG_STATE_DIR = "/tmp/foxfang-test-sticker-cache";
    fs.rmSync("/tmp/foxfang-test-sticker-cache", { recursive: true, force: true });
