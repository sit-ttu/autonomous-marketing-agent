...
import type { GetReplyOptions, MsgContext } from "foxfang/plugin-sdk/reply-runtime";
...
type FetchRemoteMediaFn = typeof import("foxfang/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as FoxFangConfig) as TelegramBotDeps["loadConfig"],
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("foxfang/plugin-sdk/media-runtime")>,
) {
...
vi.mock("foxfang/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("foxfang/plugin-sdk/agent-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("foxfang/plugin-sdk/agent-runtime")>();
  return {
    ...actual,
