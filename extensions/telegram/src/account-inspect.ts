import { resolveAccountWithDefaultFallback } from "foxfang/plugin-sdk/account-resolution";
...
import { resolveDefaultSecretProviderAlias } from "foxfang/plugin-sdk/provider-auth";
...
function inspectTokenValue(params: { cfg: FoxFangConfig; value: unknown }): {
  token: string;
