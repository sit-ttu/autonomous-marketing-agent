...
import type { TelegramNetworkConfig } from "foxfang/plugin-sdk/config-runtime";
import { isTruthyEnvValue, isWSL2Sync } from "foxfang/plugin-sdk/runtime-env";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "FOXFANG_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "FOXFANG_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "FOXFANG_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable FOXFANG_TELEGRAM_DNS_RESULT_ORDER
