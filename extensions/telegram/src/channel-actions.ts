...
} from "foxfang/plugin-sdk/channel-actions";
...
import type { TelegramActionConfig } from "foxfang/plugin-sdk/config-runtime";
import { extractToolSend } from "foxfang/plugin-sdk/tool-send";
import {
