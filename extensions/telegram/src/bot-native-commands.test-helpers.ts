...
import type { TelegramAccountConfig } from "foxfang/plugin-sdk/config-runtime";
...
type GetPluginCommandSpecsFn =
  typeof import("foxfang/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
type MatchPluginCommandFn = typeof import("foxfang/plugin-sdk/plugin-runtime").matchPluginCommand;
type ExecutePluginCommandFn =
  typeof import("foxfang/plugin-sdk/plugin-runtime").executePluginCommand;
...
vi.mock("foxfang/plugin-sdk/channel-reply-pipeline", async (importOriginal) => {
  const actual = await importOriginal<typeof import("foxfang/plugin-sdk/channel-reply-pipeline")>();
  return {
    ...actual,
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    loadConfig: vi.fn(() => params?.cfg ?? ({} as FoxFangConfig)),
