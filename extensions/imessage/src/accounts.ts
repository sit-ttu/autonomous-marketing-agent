...
function mergeIMessageAccountConfig(cfg: FoxFangConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: FoxFangConfig): ResolvedIMessageAccount[] {
