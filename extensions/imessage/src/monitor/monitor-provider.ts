...
import { createChannelPairingChallengeIssuer } from "foxfang/plugin-sdk/channel-pairing";
import { createChannelReplyPipeline } from "foxfang/plugin-sdk/channel-reply-pipeline";
import { waitForTransportReady } from "foxfang/plugin-sdk/channel-runtime";
...
import { normalizeScpRemoteHost } from "foxfang/plugin-sdk/host-runtime";
import {
  isInboundPathAllowed,
  resolveIMessageAttachmentRoots,
  resolveIMessageRemoteAttachmentRoots,
} from "foxfang/plugin-sdk/media-runtime";
import { kindFromMime } from "foxfang/plugin-sdk/media-runtime";
import {
...
import { danger, logVerbose, shouldLogVerbose, warn } from "foxfang/plugin-sdk/runtime-env";
 ...
 *   exec ssh -T foxfang@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., foxfang@192.168.64.3)
