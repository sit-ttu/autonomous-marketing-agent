import type { ChannelSetupInput } from "foxfang/plugin-sdk/channel-setup";
...
import { hasConfiguredSecretInput } from "foxfang/plugin-sdk/secret-input";
import {
...
export const nextcloudTalkSetupWizard: ChannelSetupWizard = {
  ...
  introNote: {
    ...
    lines: [
      ...
      '2) Run: ./occ talk:bot:install "FoxFang" "<shared-secret>" "<webhook-url>" --feature reaction',
