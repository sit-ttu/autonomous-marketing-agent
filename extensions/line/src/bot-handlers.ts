...
import { hasControlCommand, resolveControlCommandGate } from "foxfang/plugin-sdk/command-auth";
...
import { evaluateMatchedGroupAccessForPolicy } from "foxfang/plugin-sdk/group-access";
import {
