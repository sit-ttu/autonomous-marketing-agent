...
Nostr DM channel plugin for FoxFang using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to FoxFang. It enables your bot to:
...
# Configure foxfang to use local relay
