...
COPY --from=runtime-assets --chown=node:node /app/foxfang.mjs .
...
RUN ln -sf /app/foxfang.mjs /usr/local/bin/openclaw \
 && chmod 755 /app/foxfang.mjs
...
CMD ["node", "foxfang.mjs", "gateway", "--allow-unconfigured"]
