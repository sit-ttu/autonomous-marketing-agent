...
function resolveAcpStreamCoalesceIdleMs(cfg: FoxFangConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: FoxFangConfig): number {
...
export function resolveAcpProjectionSettings(cfg: FoxFangConfig): AcpProjectionSettings {
