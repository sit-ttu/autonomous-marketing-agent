    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["foxfang channels list", "List configured channels and auth profiles."],
          ["foxfang channels status --probe", "Run channel status checks and probes."],
          [
            "foxfang channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["foxfang channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.foxfang.ai/cli/channels",
        )}\n`,
    );
