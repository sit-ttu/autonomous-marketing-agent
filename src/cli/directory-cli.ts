    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["foxfang directory self --channel slack", "Show the connected account identity."],
          [
            'foxfang directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["foxfang directory groups list --channel discord", "List available groups/channels."],
          [
            "foxfang directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.foxfang.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
