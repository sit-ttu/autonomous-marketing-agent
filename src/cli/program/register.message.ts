...
${formatHelpExamples([
  ['foxfang message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'foxfang message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'foxfang message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.foxfang.ai/cli/message")}`,
    )
    .action(() => {
