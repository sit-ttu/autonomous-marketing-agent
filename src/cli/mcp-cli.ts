...
import { serveFoxFangChannelMcp } from "../mcp/channel-server.js";
...
export function registerMcpCli(program: Command) {
  const mcp = program.command("mcp").description("Manage FoxFang MCP config and channel bridge");

  mcp
    .command("serve")
    .description("Expose FoxFang channels over MCP stdio")
