      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["foxfang gateway run", "Run the gateway in the foreground."],
            ["foxfang gateway status", "Show service status and probe reachability."],
            ["foxfang gateway discover", "Find local and wide-area gateway beacons."],
            ["foxfang gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.foxfang.ai/cli/gateway")}\n`,
      ),
  );
