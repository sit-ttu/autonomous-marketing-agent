...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof FoxFangConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: FoxFangConfig; env: NodeJS.ProcessEnv }): {
  cfg: FoxFangConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
