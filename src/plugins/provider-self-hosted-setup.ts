...
export function applyProviderDefaultModel(cfg: FoxFangConfig, modelRef: string): FoxFangConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: FoxFangConfig; modelId: string; modelRef: string; profileId: string } {
