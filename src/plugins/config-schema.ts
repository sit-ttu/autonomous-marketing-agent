...
import type { PluginConfigUiHint, FoxFangPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: FoxFangPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): FoxFangPluginConfigSchema {
  return {
