...
import type { FoxFangPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = FoxFangPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("foxfang.pluginCommandsState");
