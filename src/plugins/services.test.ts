...
import type { FoxFangPluginService, FoxFangPluginServiceContext } from "./types.js";
...
function createRegistry(services: FoxFangPluginService[]) {
...
function expectServiceContext(
  ctx: FoxFangPluginServiceContext,
...
function expectServiceLogger(ctx: FoxFangPluginServiceContext) {
...
function expectServiceContexts(
  contexts: FoxFangPluginServiceContext[],
  config: Parameters<typeof startPluginServices>[0]["config"],
) {
...
describe("startPluginServices", () => {
  ...
  it("starts services and stops them in reverse order", async () => {
    const starts: string[] = [];
    const stops: string[] = [];
    const contexts: FoxFangPluginServiceContext[] = [];
