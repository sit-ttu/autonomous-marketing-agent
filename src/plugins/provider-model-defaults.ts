...
export function applyGoogleGeminiModelDefault(cfg: FoxFangConfig): {
  next: FoxFangConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: FoxFangConfig): FoxFangConfig {
...
export function applyOpenAIConfig(cfg: FoxFangConfig): FoxFangConfig {
...
export function applyOpencodeGoModelDefault(cfg: FoxFangConfig): {
  next: FoxFangConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: FoxFangConfig): {
  next: FoxFangConfig;
  changed: boolean;
} {
