...
function resolveSpeechProviderPluginEntries(cfg?: FoxFangConfig): SpeechProviderPlugin[] {
...
function buildProviderMaps(cfg?: FoxFangConfig): {
...
export function listSpeechProviders(cfg?: FoxFangConfig): SpeechProviderPlugin[] {
