...
const shouldWarnCompatImport =
  ...
  process.env.FOXFANG_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "foxfang/plugin-sdk/compat is deprecated for new plugins. Migrate to focused foxfang/plugin-sdk/<subpath> imports. See https://docs.foxfang.ai/plugins/sdk-migration",
    {
      code: "FOXFANG_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.foxfang.ai/plugins/sdk-migration",
    },
  );
}
