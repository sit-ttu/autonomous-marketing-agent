...
import { assertInteractiveTerminal, isSetRawModeTerminalError } from "../terminal/interactive.js";
...
export async function runInteractiveSetup(
  ...
  assertInteractiveTerminal(runtime);
  ...
  try {
    ...
    if (isSetRawModeTerminalError(err)) {
      assertInteractiveTerminal(runtime);
      return;
    }
    throw err;
