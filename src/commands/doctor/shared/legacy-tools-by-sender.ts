...
export function scanLegacyToolsBySenderKeys(cfg: FoxFangConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: FoxFangConfig): {
