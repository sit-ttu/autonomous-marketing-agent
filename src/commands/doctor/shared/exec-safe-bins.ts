...
function collectExecSafeBinScopes(cfg: FoxFangConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: FoxFangConfig): ExecSafeBinCoverageHit[] {
...
export function scanExecSafeBinTrustedDirHints(cfg: FoxFangConfig): ExecSafeBinTrustedDirHintHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: FoxFangConfig): {
