...
export function collectMissingDefaultAccountBindingWarnings(cfg: FoxFangConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: FoxFangConfig): string[] {
  const warnings: string[] = [];
