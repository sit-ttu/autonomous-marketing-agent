...
function resolveDefaultAccountId(cfg: FoxFangConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: FoxFangConfig): boolean {
...
export function summarizeBindings(cfg: FoxFangConfig, bindings: AgentBinding[]): string[] {
