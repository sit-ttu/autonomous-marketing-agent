...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.foxfang.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("foxfang hooks list")}`,
      `  ${formatCliCommand("foxfang hooks enable <name>")}`,
      `  ${formatCliCommand("foxfang hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
