...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set FOXFANG_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `foxfang dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control FoxFang.");
  } else if (hint) {
    runtime.log(hint);
  }
}
