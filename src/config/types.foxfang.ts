...
import type { MarketingConfig } from "./types.marketing.js";
...
export type FoxFangConfig = {
  meta?: {
    /** Last FoxFang version that wrote this config. */
  ...
  ui?: {
    /** Accent color for FoxFang UI chrome (hex). */
    seamColor?: string;
    assistant?: {
  ...
  memory?: MemoryConfig;
  mcp?: McpConfig;
  /** Marketing domain defaults (objects stored under state dir — see src/marketing). */
