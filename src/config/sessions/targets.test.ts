...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): FoxFangConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: FoxFangConfig, env: NodeJS.ProcessEnv) =>
