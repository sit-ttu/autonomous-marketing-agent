...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("foxfang.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("foxfang.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: FoxFangConfig): Promise<ContextEngine> {
