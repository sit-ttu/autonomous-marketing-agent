...
export const A2UI_PATH = "/__foxfang__/a2ui";

export const CANVAS_HOST_PATH = "/__foxfang__/canvas";

export const CANVAS_WS_PATH = "/__foxfang__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.foxfangCanvasA2UIAction.postMessage(...)
  // - Android: window.foxfangCanvasA2UIAction.postMessage(...)
  const handlerNames = ["foxfangCanvasA2UIAction"];
  ...
  globalThis.FoxFang = globalThis.FoxFang ?? {};
  globalThis.FoxFang.postMessage = postToNode;
  globalThis.FoxFang.sendUserAction = sendUserAction;
  globalThis.foxfangPostMessage = postToNode;
  globalThis.foxfangSendUserAction = sendUserAction;
