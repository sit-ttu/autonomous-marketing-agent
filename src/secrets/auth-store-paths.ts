...
export function listAuthProfileStorePaths(config: FoxFangConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: FoxFangConfig, stateDir: string): string[] {
