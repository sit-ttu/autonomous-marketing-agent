...
function resolveResolutionLimits(config: FoxFangConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: FoxFangConfig): SecretProviderConfig {
