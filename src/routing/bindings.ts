...
export function listBindings(cfg: FoxFangConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: FoxFangConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: FoxFangConfig) {
