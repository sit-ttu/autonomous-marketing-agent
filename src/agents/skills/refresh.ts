...
function resolveWatchPaths(workspaceDir: string, config?: FoxFangConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: FoxFangConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: FoxFangConfig }) {
