...
const FOXFANG_ATTRIBUTION_PRODUCT = "FoxFang";
const FOXFANG_ATTRIBUTION_ORIGINATOR = "foxfang";

export function resolveProviderAttributionIdentity(
  env: RuntimeVersionEnv = process.env as RuntimeVersionEnv,
): ProviderAttributionIdentity {
  return {
    product: FOXFANG_ATTRIBUTION_PRODUCT,
...
function buildOpenAIAttributionPolicy(
  ...
  return {
    ...
    ...identity,
    headers: {
      originator: FOXFANG_ATTRIBUTION_ORIGINATOR,
      version: identity.version,
      "User-Agent": `${FOXFANG_ATTRIBUTION_ORIGINATOR}/${identity.version}`,
    },
  };
}
