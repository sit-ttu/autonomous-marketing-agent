...
import { createMarketingTools } from "./tools/marketing-tools.js";
...
type FoxFangToolsDeps = {
  callGateway: typeof callGateway;
  config?: FoxFangConfig;
};

const defaultFoxFangToolsDeps: FoxFangToolsDeps = {
  callGateway,
};

let openClawToolsDeps: FoxFangToolsDeps = defaultFoxFangToolsDeps;

export function createFoxFangTools(
  options?: {
  ...
  const tools: AnyAgentTool[] = [
    ...
    ...createMarketingTools({ config: options?.config }),
...
export const __testing = {
  setDepsForTest(overrides?: Partial<FoxFangToolsDeps>) {
    openClawToolsDeps = overrides
      ? {
          ...defaultFoxFangToolsDeps,
          ...overrides,
        }
      : defaultFoxFangToolsDeps;
  },
