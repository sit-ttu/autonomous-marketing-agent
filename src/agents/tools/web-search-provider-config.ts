...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<FoxFangConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<FoxFangConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: FoxFangConfig): WebSearchConfig {
