...
export function resolveSessionToolsVisibility(cfg: FoxFangConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: FoxFangConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: FoxFangConfig): AgentToAgentPolicy {
