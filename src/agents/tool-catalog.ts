...
function buildCoreToolGroupMap() {
  ...
  const foxfangTools = CORE_TOOL_DEFINITIONS.filter((tool) => tool.includeInFoxFangGroup).map(
    (tool) => tool.id,
  );
  return {
    "group:foxfang": foxfangTools,
