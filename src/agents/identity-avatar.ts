...
function resolveAvatarSource(cfg: FoxFangConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: FoxFangConfig, agentId: string): AgentAvatarResolution {
