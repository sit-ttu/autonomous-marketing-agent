...
export function isCliProvider(provider: string, cfg?: FoxFangConfig): boolean {
...
function resolveAllowedFallbacks(params: { cfg: FoxFangConfig; agentId?: string }): string[] {
  if (params.agentId) {
...
export function buildConfiguredModelCatalog(params: { cfg: FoxFangConfig }): ModelCatalogEntry[] {
