...
function resolveAdaptiveReadMaxBytes(options?: FoxFangReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createFoxFangReadTool(base, {
...
export function createFoxFangReadTool(
  base: AnyAgentTool,
  options?: FoxFangReadToolOptions,
): AnyAgentTool {
  ...
  return {
    ...
    execute: async (toolCallId, params, signal) => {
      ...
      const readArgs = (normalized ?? params ?? {}) as Record<string, unknown>;
      ...
      try {
        ...
        const missingDailyMemoryPath = normalizeDailyMemoryReadPath(readArgs.path);
