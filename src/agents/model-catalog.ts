...
import { ensureFoxFangModelsJson } from "./models-config.js";
...
function shouldLogModelCatalogTiming(): boolean {
  return process.env.FOXFANG_DEBUG_INGRESS_TIMING === "1";
}
...
function readConfiguredOptInProviderModels(config: FoxFangConfig): ModelCatalogEntry[] {
