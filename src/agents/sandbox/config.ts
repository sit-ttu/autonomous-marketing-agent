...
const DEFAULT_SANDBOX_SSH_WORKSPACE_ROOT = "/tmp/foxfang-sandboxes";
...
export function resolveSandboxConfigForAgent(cfg?: FoxFangConfig, agentId?: string): SandboxConfig {
