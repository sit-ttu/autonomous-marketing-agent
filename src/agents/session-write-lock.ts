...
const CLEANUP_STATE_KEY = Symbol.for("foxfang.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("foxfang.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("foxfang.sessionWriteLockWatchdogState");
