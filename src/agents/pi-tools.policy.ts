...
export function resolveSubagentToolPolicy(cfg?: FoxFangConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: FoxFangConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: FoxFangConfig["tools"];
