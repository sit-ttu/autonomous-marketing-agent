import type { FoxFangConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveIdentityNamePrefix(cfg: FoxFangConfig, agentId: string): string | undefined {
...
export function resolveIdentityName(cfg: FoxFangConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[foxfang]";
}
