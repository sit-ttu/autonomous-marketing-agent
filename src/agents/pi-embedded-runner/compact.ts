...
import { describeUnknownError, mapThinkingLevel, normalizeContextTokenBudget } from "./utils.js";
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureFoxFangModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createFoxFangCodingTools({
      exec: {
