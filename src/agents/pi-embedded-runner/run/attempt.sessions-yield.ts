...
const SESSIONS_YIELD_INTERRUPT_CUSTOM_TYPE = "foxfang.sessions_yield_interrupt";
const SESSIONS_YIELD_CONTEXT_CUSTOM_TYPE = "foxfang.sessions_yield";
const SESSIONS_YIELD_ABORT_SETTLE_TIMEOUT_MS = process.env.FOXFANG_TEST_FAST === "1" ? 250 : 2_000;
