...
export function isAcpEnabledByPolicy(cfg: FoxFangConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: FoxFangConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: FoxFangConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: FoxFangConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: FoxFangConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: FoxFangConfig, agentId: string): boolean {
