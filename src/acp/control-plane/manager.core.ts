...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: FoxFangConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: FoxFangConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: FoxFangConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: FoxFangConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: FoxFangConfig }): Promise<void> {
