...
export function hasAmbiguousGatewayAuthModeConfig(cfg: FoxFangConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: FoxFangConfig): void {
