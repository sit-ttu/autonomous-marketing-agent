...
const gatewayEnv = {
  FOXFANG_GATEWAY_TOKEN: "env-token", // pragma: allowlist secret
  FOXFANG_GATEWAY_PASSWORD: "env-password", // pragma: allowlist secret
} as NodeJS.ProcessEnv;

function makeRemoteGatewayConfig(remote: { token?: string; password?: string }): FoxFangConfig {
  return {
    gateway: {
      mode: "remote",
      remote,
