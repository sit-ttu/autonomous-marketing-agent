...
export function collectConfiguredModelPricingRefs(config: FoxFangConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: FoxFangConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
