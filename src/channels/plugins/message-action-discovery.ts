...
export function listChannelMessageActions(cfg: FoxFangConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: FoxFangConfig): ChannelMessageCapability[] {
