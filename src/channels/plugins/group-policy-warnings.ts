...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: FoxFangConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: FoxFangConfig }>(
  collector: WarningCollector<{ cfg: FoxFangConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: FoxFangConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: FoxFangConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: FoxFangConfig },
>(
  projectCfg: (cfg: FoxFangConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  params: {
    providerConfigPresent: (cfg: FoxFangConfig) => boolean;
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: FoxFangConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: FoxFangConfig },
>(params: {
  providerConfigPresent: (cfg: FoxFangConfig) => boolean;
