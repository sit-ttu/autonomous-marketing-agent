...
export type ChannelAgentToolFactory = (params: { cfg?: FoxFangConfig }) => ChannelAgentTool[];
...
export type ChannelMessagingAdapter = {
  ...
  enableInteractiveReplies?: (params: { cfg: FoxFangConfig; accountId?: string | null }) => boolean;
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: FoxFangConfig; accountId?: string | null }) => string[];
};
