...
export type ChannelOnboardingPostWriteHook = {
  channel: ChannelId;
  accountId: string;
  run: (ctx: { cfg: FoxFangConfig; runtime: RuntimeEnv }) => Promise<void> | void;
};
...
export type ChannelSetupDmPolicy = {
  ...
  getCurrent: (cfg: FoxFangConfig, accountId?: string) => DmPolicy;
  setPolicy: (cfg: FoxFangConfig, policy: DmPolicy, accountId?: string) => FoxFangConfig;
