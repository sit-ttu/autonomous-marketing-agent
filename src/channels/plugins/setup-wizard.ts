...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: FoxFangConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: FoxFangConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: FoxFangConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: FoxFangConfig; accountId: string }) => boolean;
  inspect: (params: { cfg: FoxFangConfig; accountId: string }) => ChannelSetupWizardCredentialState;
  shouldPrompt?: (params: {
    cfg: FoxFangConfig;
    accountId: string;
    credentialValues: ChannelSetupWizardCredentialValues;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: FoxFangConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: FoxFangConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: FoxFangConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: FoxFangConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: FoxFangConfig) => FoxFangConfig;
