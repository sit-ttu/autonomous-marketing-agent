...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: FoxFangConfig): string | undefined {
  ...
  function listAccountIds(cfg: FoxFangConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: FoxFangConfig): string {
