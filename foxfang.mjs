...
const buildMissingEntryErrorMessage = async () => {
  const lines = ["foxfang: missing dist/entry.(m)js (build output)."];
  ...
  lines.push(
    "For pinned GitHub installs, use `npm install -g github:potlock/foxfang#<ref>` instead of a raw `/archive/<ref>.tar.gz` URL.",
  );
  lines.push("For releases, use `npm install -g foxfang@latest`.");
  return lines.join("\n");
};
