...
FoxFang treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.foxfang/settings/voicewake.json`

Shape:

```json
{ "triggers": ["foxfang", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
