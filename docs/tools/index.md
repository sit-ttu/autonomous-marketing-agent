---
summary: "FoxFang tools and plugins overview: what the agent can do and how to extend it"
read_when:
  - You want to understand what tools FoxFang provides
...
<Steps>
  ...
  <Step title="Plugins package everything together">
    ...
    Some plugins are **core** (shipped with FoxFang), others are **external**
...
These tools ship with FoxFang and are available without installing any plugins:
...
| `group:nodes`      | nodes                                                                                                     |
| `group:foxfang`    | All built-in FoxFang tools (excludes plugin tools)                                                        |
