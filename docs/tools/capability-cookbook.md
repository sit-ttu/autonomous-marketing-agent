---
summary: "Contributor guide for adding a new shared capability to the FoxFang plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for FoxFang core developers. If you are
  building an external plugin, see [Building Plugins](/plugins/building-plugins)
  instead.
</Info>

Use this when FoxFang needs a new domain such as image generation, video
