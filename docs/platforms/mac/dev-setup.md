---
summary: "Setup guide for developers working on the FoxFang macOS app"
read_when:
...
This guide covers the necessary steps to build and run the FoxFang macOS application from source.
...
To build the macOS app and package it into `dist/FoxFang.app`, run:
...
The macOS app expects a global `foxfang` CLI install to manage background tasks.

**To install it (recommended):**

1. Open the FoxFang app.
