---
summary: "Use Qianfan's unified API to access many models in FoxFang"
read_when:
...
3. FoxFang installed on your system
...
4. Copy the API key for use with FoxFang

## CLI setup

```bash
foxfang onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [FoxFang Configuration](/gateway/configuration)
