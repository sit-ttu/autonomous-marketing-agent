---
summary: "Use Xiaomi MiMo models with FoxFang"
read_when:
  - You want Xiaomi MiMo models in FoxFang
...
Xiaomi MiMo is the API platform for **MiMo** models. FoxFang uses the Xiaomi
...
```bash
foxfang onboard --auth-choice xiaomi-api-key
# or non-interactive
foxfang onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
