...
You can point FoxFang at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or FoxFang
...
- [Anthropic provider](/providers/anthropic) - Native FoxFang integration with Claude setup-token or API keys
