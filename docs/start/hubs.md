---
summary: "Hubs that link to every FoxFang doc"
read_when:
...
<Note>
If you are new to FoxFang, start with [Getting Started](/start/getting-started).
</Note>
...
- [FoxFang assistant](/start/foxfang)
...
- [Templates: BRAND](/reference/templates/BRAND)
- [Templates: PRODUCT](/reference/templates/PRODUCT)
