---
summary: "First-run setup flow for FoxFang (macOS app)"
read_when:
...
- By default, FoxFang is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give FoxFang">
...
<Step title="CLI">
  ...
  The app can install the global `foxfang` CLI via npm/pnpm so terminal
