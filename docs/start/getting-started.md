---
summary: "Get FoxFang installed and run your first chat in minutes."
read_when:
...
<Accordion title="Advanced: environment variables">
  If you run FoxFang as a service account or want custom paths:

- `FOXFANG_HOME` — home directory for internal path resolution
- `FOXFANG_STATE_DIR` — override the state directory
- `FOXFANG_CONFIG_PATH` — override the config file path
