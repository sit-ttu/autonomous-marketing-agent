---
summary: "Overview of FoxFang onboarding options and flows"
read_when:
...
FoxFang has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `foxfang onboard`                      | Launch the app            |
...
CLI command docs: [`foxfang onboard`](/cli/onboard)

## macOS app onboarding

Open the FoxFang app. The first-run wizard walks you through the same steps
