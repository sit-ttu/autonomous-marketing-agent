---
summary: "Run FoxFang Gateway 24/7 on a cheap Hetzner VPS (Docker) with durable state and baked-in binaries"
read_when:
  - You want FoxFang running 24/7 on a cloud VPS (not your laptop)
  - You want a production-grade, always-on Gateway on your own VPS
  - You want full control over persistence, binaries, and restart behavior
  - You are running FoxFang in Docker on Hetzner or a similar provider
title: "Hetzner"
---

# FoxFang on Hetzner (Docker, Production VPS Guide)

## Goal

Run a persistent FoxFang Gateway on a Hetzner VPS using Docker, with durable state, baked-in binaries, and safe restart behavior.

If you want “FoxFang 24/7 for ~$5”, this is the simplest reliable setup.
...
<Steps>
  ...
  <Step title="Configure environment variables">
    ...
    FOXFANG_CONFIG_DIR=/root/.foxfang
    FOXFANG_WORKSPACE_DIR=/root/.foxfang/workspace
...
- Infrastructure: [foxfang-terraform-hetzner](https://github.com/andreesg/foxfang-terraform-hetzner)
- Docker config: [foxfang-docker-config](https://github.com/andreesg/foxfang-docker-config)
