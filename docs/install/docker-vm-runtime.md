...
| WhatsApp session    | `/home/node/.foxfang/`           | Host volume mount      | Preserves QR login              |
| Gmail keyring       | `/home/node/.foxfang/`           | Host volume + password | Requires `GOG_KEYRING_PASSWORD` |
