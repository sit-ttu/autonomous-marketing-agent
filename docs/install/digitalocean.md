---
summary: "Host FoxFang on a DigitalOcean Droplet"
read_when:
  - Setting up FoxFang on DigitalOcean
  - Looking for a simple paid VPS for FoxFang
title: "DigitalOcean"
---

# DigitalOcean

Run a persistent FoxFang Gateway on a DigitalOcean Droplet.
...
**Gateway will not start** -- Run `foxfang doctor --non-interactive` and check logs with `journalctl --user -u foxfang-gateway.service -n 50`.
