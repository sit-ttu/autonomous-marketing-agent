...
FoxFang selects models in this order:
...
- `agents.defaults.models` is the allowlist/catalog of models FoxFang can use (plus aliases).
...
foxfang models set <provider/model>
foxfang models set-image <provider/model>

foxfang models aliases list
foxfang models aliases add <alias> <provider/model>
foxfang models aliases remove <alias>

foxfang models fallbacks list
foxfang models fallbacks add <provider/model>
foxfang models fallbacks remove <provider/model>
foxfang models fallbacks clear

foxfang models image-fallbacks list
foxfang models image-fallbacks add <provider/model>
foxfang models image-fallbacks remove <provider/model>
foxfang models image-fallbacks clear
```

`foxfang models` (no subcommand) is a shortcut for `models status`.
...
`foxfang models scan` inspects OpenRouter’s **free model catalog** and can
...
agent directory (default `~/.foxfang/agents/<agentId>/agent/models.json`). This file
...
Marker persistence is source-authoritative: FoxFang writes markers from the active source config snapshot (pre-resolution), not from resolved runtime secret values.
This applies whenever FoxFang regenerates `models.json`, including command-driven paths like `foxfang agent`.
