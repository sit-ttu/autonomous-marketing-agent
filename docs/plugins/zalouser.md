...
read_when:
  - You want Zalo Personal (unofficial) support in FoxFang
...
Zalo Personal support for FoxFang via a plugin, using native `zca-js` to automate a normal Zalo user account.
