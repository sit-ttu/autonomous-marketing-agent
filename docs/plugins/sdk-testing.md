...
summary: "Testing utilities and patterns for FoxFang plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for FoxFang
plugins.
...
**Import:** `foxfang/plugin-sdk/testing`
...
import { installCommonResolveTargetErrorCases } from "foxfang/plugin-sdk/testing";
...
import type { PluginRuntime } from "foxfang/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `foxfang/plugin-sdk` root barrel is rejected
...
FoxFang uses Vitest with V8 coverage thresholds. For plugin tests:
