...
FoxFang has three related (but different) controls:
...
Use the inspector to see what FoxFang is _actually_ doing:
...
- `group:nodes`: `nodes`
- `group:foxfang`: all built-in FoxFang tools (excludes provider plugins)
