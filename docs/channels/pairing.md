...
read_when:
  ...
  - Reviewing FoxFang security posture
title: "Pairing"
---

# Pairing

“Pairing” is FoxFang’s explicit **owner approval** step.
...
Supported channels: `bluebubbles`, `discord`, `feishu`, `googlechat`, `imessage`, `irc`, `line`, `matrix`, `mattermost`, `msteams`, `nextcloud-talk`, `nostr`, `foxfang-weixin`, `signal`, `slack`, `synology-chat`, `telegram`, `twitch`, `whatsapp`, `zalo`, `zalouser`.
...
3. On your phone, open the FoxFang iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `foxfang nodes pending/approve`) is a
