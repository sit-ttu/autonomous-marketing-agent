...
- Install via CLI: `foxfang plugins install @foxfang/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `foxfang plugins install ./extensions/zalo`
   - From npm (if published): `foxfang plugins install @foxfang/zalo`
...
This page reflects current FoxFang behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `foxfang pairing list zalo`
  - `foxfang pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in FoxFang.
...
- Example: `foxfang message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `foxfang channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `foxfang logs --follow`
