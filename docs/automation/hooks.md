...
- **📝 command-logger**: Logs all command events to `~/.foxfang/logs/commands.log`
...
- **Managed hooks** (`~/.foxfang/hooks/`): Shared across workspaces; can override bundled and plugin hooks
