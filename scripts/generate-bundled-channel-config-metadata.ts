...
function resolvePackageChannelMeta(source: BundledPluginSource) {
  const foxfangMeta =
    ...
    "foxfang" in source.packageJson
      ? (source.packageJson.foxfang as Record<string, unknown> | undefined)
      : undefined;
  const channelMeta =
    foxfangMeta &&
    typeof foxfangMeta.channel === "object" &&
    foxfangMeta.channel &&
    !Array.isArray(foxfangMeta.channel)
      ? (foxfangMeta.channel as Record<string, unknown>)
      : undefined;
  return channelMeta;
}
