...
export DISPLAY=:1
export HOME=/tmp/foxfang-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${FOXFANG_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${FOXFANG_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${FOXFANG_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${FOXFANG_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${FOXFANG_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${FOXFANG_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${FOXFANG_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${FOXFANG_BROWSER_NOVNC_PASSWORD:-}"
DISABLE_GRAPHICS_FLAGS="${FOXFANG_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${FOXFANG_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${FOXFANG_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
